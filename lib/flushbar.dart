...
class Flushbar<T> extends StatefulWidget {
  ...
  /// Default is 8.0. Defines the width of the left bar indicator if present
  final double? leftBarIndicatorWidth;
...
class _FlushbarState<K extends Object?> extends State<Flushbar<K>> with TickerProviderStateMixin {
    ...
    if (widget.leftBarIndicatorColor != null) {
      return FutureBuilder(
        ...
        builder: (BuildContext buildContext, AsyncSnapshot<Size> snapshot) {
          if (snapshot.hasData) {
            return Container(
              width: widget.leftBarIndicatorWidth ?? 8.0,
              height: snapshot.data!.height,
              decoration: BoxDecoration(
  ...
  Text _getDefaultNotificationText() {
    return Text(
      widget.message ?? '',
      style: TextStyle(
          fontSize: widget.messageSize ?? 14.0, color: widget.messageColor ?? Colors.white),
    );
  }
